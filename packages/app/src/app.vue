...
import config from "@leeward-ui/utils/config";
...
export default defineComponent({
  ...
  setup() {
    ...
    const leewardui = instance?.appContext.config.globalProperties.$leewardui;
    const getBreakpoint = () => {
